...
public class AdminController {
    ...
    @ResponseBody
    public PageInfo<User> findAllUserByPage(@RequestParam(value = "page") int page, @RequestParam(value = "offset") int offset){
    ...
    @ResponseBody
    public PageInfo<Car> findAllCarByPage(@RequestParam(value = "page") int page, @RequestParam(value = "offset") int offset){
